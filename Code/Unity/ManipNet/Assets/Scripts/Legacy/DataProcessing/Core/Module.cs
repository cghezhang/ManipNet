...
public abstract class Module : ScriptableObject {
	...
	public enum ID {TimeSeries, Root, Style, Goal, Phase, Contact, HeightMap, DepthMap, CylinderMap, CuboidMap, SphereMap, DistanceMap, Motion, Alignment, 
					HandTimeSeries, HandObjectTransformation, HandObject, HandCollider, HandContact, HandContactFrequency, ObjectReplacement, HandAction, Crowd, Length};
